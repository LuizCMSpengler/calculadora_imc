        ...
        for (let idx = 0; idx < classification.length; idx++) {
            ...
            if (imc > item.min && imc < item.max) {
                ...
                element.forEach((line) => {
                    if (item.min > 18.4 && item.max < 25) {
                        line.style.backgroundColor = '#557711';
                        line.style.color = 'white';
                    }
                    else {
                        line.style.backgroundColor = '#721';
                        line.style.color = 'white';
                    }
                })
            } else {
        ...
        <Row className='justify-content-center mt-5'>
            <Col xs={7}>
                <Table bordered>
                    <thead>
                        <tr>
                            <th colSpan={2} className='text-center' style={{ backgroundColor: '#8c7ae6', color: 'white' }}>
